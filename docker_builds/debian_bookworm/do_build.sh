...
cd ..
sh make_debian_package.sh ./build $BUILD_ARCH 'libc6, libgcc-s1, libstdc++6, libqt6core6, libqt6widgets6, libqt6gui6, libqt6network6, libqcustomplot2.1-qt6, libfftw3-single3, libairspy0, libuhd4.3.0, libhackrf0' ''